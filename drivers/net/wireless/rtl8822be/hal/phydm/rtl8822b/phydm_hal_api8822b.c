...
)
{
	...
	} else if ((p_dm_odm->rfe_type == 0) || (p_dm_odm->rfe_type == 3) || (p_dm_odm->rfe_type == 5) || (p_dm_odm->rfe_type == 8) || (p_dm_odm->rfe_type == 10) || (p_dm_odm->rfe_type == 12) || (p_dm_odm->rfe_type == 13) || (p_dm_odm->rfe_type == 12)) {
		/* iFEM */
		if (channel <= 14) {
			/* signal source */
			odm_set_bb_reg(p_dm_odm, 0xcb0, (MASKBYTE2 | MASKLWORD), 0x745774);
...
)
{
	...
	if (central_ch <= 14) {
		...
		/* SoML on */
		if ((reg_8 == 0x1) && (!((p_dm_odm->rfe_type == 0) || (p_dm_odm->rfe_type == 3) || (p_dm_odm->rfe_type == 5) || (p_dm_odm->rfe_type == 8) || (p_dm_odm->rfe_type == 10) || (p_dm_odm->rfe_type == 12) || (p_dm_odm->rfe_type == 13) || (p_dm_odm->rfe_type == 14)))) {
		...
		/* SoML off */
		} else if ((reg_8 == 0x0) && ((p_dm_odm->rfe_type == 1) || (p_dm_odm->rfe_type == 6) || (p_dm_odm->rfe_type == 7) || (p_dm_odm->rfe_type == 9))) {
			odm_set_bb_reg(p_dm_odm, 0x8cc, MASKDWORD, 0x08100000);
			odm_set_bb_reg(p_dm_odm, 0x8d8, BIT(27), 0x0);
...
)
{
	...
	case ODM_BW80M:
	{
		...
		if ((rfe_type == 2) || (rfe_type == 3)) {
			odm_set_bb_reg(p_dm_odm, 0x840, 0x0000f000, 0x6);
			odm_set_bb_reg(p_dm_odm, 0x8c8, BIT(10), 0x1);
		}
